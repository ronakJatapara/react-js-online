...
//   return (
//     <div className={`p-4 rounded shadow-md ${themeMode === 'light' ? 'bg-white text-black' : 'bg-gray-800 text-white'}`}>
//       <h1 className="text-lg font-bold">Theme Card</h1>
//       <p>The current theme is {themeMode}.</p>
//     </div>
//   );
// }
